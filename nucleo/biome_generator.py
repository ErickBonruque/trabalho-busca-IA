...
class BiomeGenerator:
    ...
    def __init__(self, seed=None):
        ...
        self.biome_ranges = [
            (0.0, 0.4, TipoTerreno.SOLIDO),   # 40% - Terreno sólido
            (0.4, 0.6, TipoTerreno.ARENOSO),  # 20% - Terreno arenoso  
            (0.6, 0.8, TipoTerreno.ROCHOSO),  # 20% - Terreno rochoso
            (0.8, 1.0, TipoTerreno.PANTANO)   # 20% - Pântano
        ]
    
    def generate_biome_map(self, width, height, scale=0.1, octaves=4):
        """
    ...
    def generate_biome_for_position(self, x, y, scale=0.1, octaves=4):
        """
...
def gerar_biomas_naturais(width, height, seed=None, scale=0.1, octaves=4):
    """
...
if __name__ == "__main__":
    ...
    biome_map, stats = gerar_biomas_naturais(20, 10, seed=42, scale=0.1)
